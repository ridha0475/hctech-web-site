...
const STR = {
	fr: {
		...
		'c1.fig': 'Vue éclatée de la GLRV II : caisson inox, réservoir à charbon actif, pompe à vide, condenseur et vannes.',
		'machine.install.title': 'Intégration à la station-service',
		'machine.install.body': "La GLRV II se raccorde au réseau d'évent du réservoir souterrain. Elle reçoit les vapeurs générées lors de la livraison et de la distribution, renvoie le carburant liquéfié vers la cuve et rejette un air épuré.",
	...
	en: {
		...
		'c1.fig': 'Exploded view of the GLRV II: stainless-steel enclosure, activated-carbon tank, vacuum pump, condenser and valves.',
		'machine.install.title': 'Service-station integration',
		'machine.install.body': 'The GLRV II connects to the underground tank vent network. It receives vapors generated during delivery and dispensing, returns liquefied fuel to the tank and releases purified air.',
	...
	ar: {
		...
		'c1.fig': 'منظر تفصيلي لوحدة GLRV II: الهيكل وخزان الفحم النشط ومضخة التفريغ والمكثف والصمامات.',
		'machine.install.title': 'الدمج في محطة الوقود',
		'machine.install.body': 'تتصل GLRV II بشبكة تهوية الخزان الأرضي، فتستقبل الأبخرة الناتجة عن التزويد والتوزيع وتعيد الوقود المسال إلى الخزان وتطرح هواءً منقّى.',
