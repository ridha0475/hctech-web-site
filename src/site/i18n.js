...
const STR = {
	fr: {
		...
		'machine.install.body': "La GEVLR-II se raccorde au réseau d'évent du réservoir souterrain. Elle traite uniquement les vapeurs présentes dans la cuve de stockage, renvoie le carburant liquéfié vers cette cuve et rejette un air épuré.",
	...
	en: {
		...
		'machine.install.body': 'The GEVLR-II connects to the underground tank vent network. It treats only the vapors present in the storage tank, returns liquefied fuel to that tank and releases purified air.',
	...
	ar: {
		...
		'machine.install.body': 'تتصل GEVLR-II بشبكة تهوية الخزان الأرضي، وتعالج حصراً الأبخرة الموجودة داخل خزان التخزين، ثم تعيد الوقود المسال إلى الخزان وتطرح هواءً منقّى.',
